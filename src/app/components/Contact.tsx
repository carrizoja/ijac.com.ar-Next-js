  ...
  const contactInfo = [
    {
      ...
      title: content.cards.location.title,
      info: "Almagro, Buenos Aires",
      subInfo: content.cards.location.subInfo,
    ...
    },
    {
      ...
      title: content.cards.instagram.title,
      info: "@ijacsi",
      subInfo: content.cards.instagram.subInfo,
    ...
    },
    {
      ...
      title: content.cards.facebook.title,
      info: "iJac IT Solutions",
      subInfo: content.cards.facebook.subInfo,
