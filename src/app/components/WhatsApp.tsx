...
const WhatsApp = () => {
  ...
  const handleWhatsAppClick = () => {
    const phoneNumber = '5491130862409'; // Example: Argentina number
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        ...
        {/* Glow effect */}
        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-green-400 to-green-600 opacity-0 group-hover:opacity-30 transition-opacity duration-300 blur-md scale-110"></div>
