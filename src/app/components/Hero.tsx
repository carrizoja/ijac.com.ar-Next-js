  ...
  return (
    <HeroHighlight>
      <motion.h1
        ...
        className="text-2xl px-4 md:text-4xl lg:text-5xl font-bold text-neutral-700 dark:text-white max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto overflow-hidden"
      >
        iJAC IT Solutions
      </motion.h1>
       <motion.h2
